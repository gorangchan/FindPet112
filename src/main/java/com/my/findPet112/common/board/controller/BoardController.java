...
import com.my.findPet112.common.board.service.PagingBean;
...
public class BoardController {
	...
	public String list(@PathVariable String pageNum, BoardVO board, Model model) {
...
//		Collection<BoardVO> list = bs.list(startRow, endRow);
		Collection<BoardVO> list = bs.list(board);
	...
	public String update(BoardVO board, String pageNum, Model model) {
